...
export class WorkComponent extends HTMLElement {
    ...
    render() {
      ...
      <div class="container" id="ciudadWork" style="display:block;">
          <ciudad-work></ciudad-work>
      </div> 
      <div class="container" id="companiaWork" style="display:block;">
          <compania-work></compania-work>
      </div>
      <div class="container" id="marcaWork" style="display:block;">
